...
const T = {
  es: {
    ...
    // ── Active Directory ──
    lab_title_ad_smb_enum:        'AD 01 – Enumeración SMB y sesión nula',
    lab_title_ad_ldap_enum:       'AD 02 – Enumeración LDAP',
    lab_title_ad_password_spray:  'AD 03 – Password Spraying',
    lab_title_ad_asrep_roast:     'AD 04 – AS-REP Roasting',
    lab_title_ad_kerberoast:      'AD 05 – Kerberoasting',
    lab_title_ad_gpp_passwords:   'AD 06 – Contraseñas GPP en SYSVOL',
    lab_title_ad_bloodhound:      'AD 07 – BloodHound y rutas de ataque',
    lab_title_ad_acl_genericall:  'AD 08 – Abuso de ACL: GenericAll',
    lab_title_ad_acl_writemember: 'AD 09 – Abuso de ACL: AddSelf a grupo',
    lab_title_ad_dcsync:          'AD 10 – DCSync',
    lab_title_ad_pth:             'AD 11 – Pass-the-Hash',
    lab_title_ad_silver_ticket:   'AD 12 – Silver Ticket',
    ...
    ad_env_foothold_val: 'svc.readonly / ReadOnly123!  (se obtiene en el lab AD 01)',
    ...
    ad_env_foothold_hint: 'se obtiene en el lab AD 01',
    ad_obj_flag_where:   '— captúrala en el Domain Controller y valídala en la barra lateral.',
    ad_quickstart:       'Inicio rápido',
    ad_smb_enum_obj_desc: 'El Domain Controller acepta sesiones nulas y tiene la cuenta Guest habilitada: puedes listar recursos y enumerar usuarios sin credenciales. El recurso //DC01/public es legible de forma anónima y contiene la flag, además de las credenciales de servicio que necesitarás en el resto de laboratorios.',
    ad_ldap_enum_obj_desc: 'Con la cuenta de servicio svc.readonly, vuelca los objetos del directorio por LDAP. El servidor permite binds simples sin cifrado y un administrador dejó escrita una contraseña —y la flag— en el atributo description de un usuario.',
  ...
  en: {
    ...
    lab_title_session_hijacking: 'Session Hijacking',
    // ── Active Directory ──
    lab_title_ad_smb_enum:        'AD 01 – SMB Enumeration & Null Session',
    lab_title_ad_ldap_enum:       'AD 02 – LDAP Enumeration',
    lab_title_ad_password_spray:  'AD 03 – Password Spraying',
    lab_title_ad_asrep_roast:     'AD 04 – AS-REP Roasting',
    lab_title_ad_kerberoast:      'AD 05 – Kerberoasting',
    lab_title_ad_gpp_passwords:   'AD 06 – GPP Passwords in SYSVOL',
    lab_title_ad_bloodhound:      'AD 07 – BloodHound & Attack Paths',
    lab_title_ad_acl_genericall:  'AD 08 – ACL Abuse: GenericAll',
    lab_title_ad_acl_writemember: 'AD 09 – ACL Abuse: AddSelf to group',
    lab_title_ad_dcsync:          'AD 10 – DCSync',
    lab_title_ad_pth:             'AD 11 – Pass-the-Hash',
    lab_title_ad_silver_ticket:   'AD 12 – Silver Ticket',
    lab_title_ad_golden_ticket:   'AD 13 – Golden Ticket',
    ...
    ad_env_foothold_val: 'svc.readonly / ReadOnly123!  (obtained in lab AD 01)',
    ...
    ad_env_foothold_hint: 'obtained in lab AD 01',
    ad_obj_flag_where:   '— capture it on the Domain Controller and validate it in the sidebar.',
    ad_quickstart:       'Quick start',
    ad_smb_enum_obj_desc: 'The Domain Controller accepts null sessions and has the Guest account enabled: you can list shares and enumerate users with no credentials. The //DC01/public share is anonymously readable and holds the flag, plus the service credentials you will need for the rest of the labs.',
    ad_ldap_enum_obj_desc: 'Using the svc.readonly service account, dump the directory objects over LDAP. The server allows simple binds without encryption and an administrator left a password — and the flag — written in a user description attribute.',
